...
export class TeacherAvailabilityComponent {
  ...
  st_msg:any;
  getSumOFDayOffs(weekName: string, elmIdName: string, disableBtnName: any) {
    ...
    if (
      this.sumOfday > 2 &&
      (document.getElementById(elmIdName) as HTMLInputElement).checked == true
    ) {
//here here
    ...
    // alert('More than two daysoff  is not possible');
      ...
      this.all_msgs = 'More than two daysoff  is not possible';
      this.messageEvent.emit(this.all_msgs);
       this.rc_status = true;
      ...
      (document.getElementById(elmIdName) as HTMLInputElement).checked = false;
      this.weekdaysDayOffList[weekName] = 0;
    }
    ...
    if (
      ...
      this.sumOfday = 1;
      this.weekdaysDayOffList[weekName] = 0;
      this.weekdayDisable[disableBtnName] = false;
    ...
    if (
      ...
      this.weekdayDisable[disableBtnName] = true;
      this.weekdaysDayOffList[weekName] = 1;
    }
  }
  ...
  onDayOffSelectSun(e: any, day: string) {
    ...
    this.getSumOFDayOffs(day, 'sun_Dayoff', 'Sunday');

    console.log(this.btnDisableSun);
    console.log('sumOndis', this.sumOfday);
  }
  onDayOffSelectMon(e: any, day: string) {
    debugger;

    this.getSumOFDayOffs(day, 'mon_Dayoff', 'Monday');
    ...
    // alert(this.weekdaysDayOffList[day]);
  }
  onDayOffSelectTue(e: any, day: string) {
    debugger;

    // this.getSumOFDayOffs();
    this.getSumOFDayOffs(day, 'tue_Dayoff', 'Tuesday');
  ...
  onDayOffSelectWed(e: any, day: string) {
    ...
    // this.getSumOFDayOffs();
    this.getSumOFDayOffs(day, 'wed_Dayoff', 'Wednesday');
  ...
  onDayOffSelectThu(e: any, day: string) {
    ...
    // this.getSumOFDayOffs();
    this.getSumOFDayOffs(day, 'thrs_Dayoff', 'Thursday');
  ...
  onDayOffSelectFri(e: any, day: string) {
    ...
    // this.getSumOFDayOffs();
    this.getSumOFDayOffs(day, 'fri_Dayoff', 'Friday');
  ...
  onDayOffSelectSat(e: any, day: string) {
    ...
    this.getSumOFDayOffs(day, 'sat_Dayoff', 'Saturday');
  ...
  checkAvail() {
    ...
    this.date_time[0].forEach((value: any) => {
      debugger;
      this.weekdaysDayOffList;
      console.log('dateTime', value);
      value.Monday.forEach((val: any) => {
        // console.log('date', val);
        let monVal = (document.getElementById(val) as HTMLInputElement).value;

        if (this.MondayList.length == 0 && this.availData != null) {
          this.btnDisableMon = true;
          this.weekdayDisable['Monday'] = true;
        ...
        this.MondayList.forEach((monTiming: any) => {
          ...
          if (monVal == monTiming) {
            ...
            checkArray.push(new FormControl(monVal));
          }
        });
      });
    });
    ...
    this.date_time[1].forEach((value: any) => {
      ...
      value.Tuesday.forEach((val: any) => {
        ...
        if (this.TueList.length == 0 && this.availData != null) {
          this.btnDisableTue = true;
          this.weekdayDisable['Tuesday'] = true;
        ...
        this.TueList.forEach((tueTiming: any) => {
          if (tueVal == tueTiming) {
            (
              document.getElementById('tue' + '_' + tueVal) as HTMLInputElement
            ).checked = true;

            const checkArray: FormArray = this.checkBoxform.get(
              'Tuesday'
            ) as FormArray;
            checkArray.push(new FormControl(tueVal));
          }
        });
    ...
    this.date_time[2].forEach((value: any) => {
      value.Wednesday.forEach((val: any) => {
        ...
        if (this.WedList.length == 0 && this.availData != null) {
          this.btnDisableWed = true;
          this.weekdayDisable['Wednesday'] = true;
        ...
        this.WedList.forEach((wedTiming: any) => {
          if (wedVal == wedTiming) {
            (
              document.getElementById('wed' + '_' + wedVal) as HTMLInputElement
            ).checked = true;

            const checkArray: FormArray = this.checkBoxform.get(
              'Wednesday'
            ) as FormArray;
            checkArray.push(new FormControl(wedVal));
          }
        });
    ...
    this.date_time[3].forEach((value: any) => {
      value.Thursday.forEach((val: any) => {
        ...
        if (this.ThursList.length == 0 && this.availData != null) {
          this.btnDisableThu = true;
          this.weekdayDisable['Thursday'] = true;
        ...
        this.ThursList.forEach((thuTiming: any) => {
          if (thuVal == thuTiming) {
            ...
            checkArray.push(new FormControl(thuVal));
          }
        });
    ...
    this.date_time[4].forEach((value: any) => {
      value.Friday.forEach((val: any) => {
        ...
        if (this.FriList.length == 0 && this.availData != null) {
          this.btnDisableFri = true;
          this.weekdayDisable['Friday'] = true;
        ...
        this.FriList.forEach((friTiming: any) => {
          if (friVal == friTiming) {
            ...
            checkArray.push(new FormControl(friVal));
          }
        });
      });
    });
    ...
    this.date_time[5].forEach((value: any) => {
      value.Saturday.forEach((val: any) => {
        ...
        if (this.SatList.length == 0 && this.availData != null) {
          this.btnDisableSat = true;
          this.weekdayDisable['Saturday'] = true;
        ...
        this.SatList.forEach((satTiming: any) => {
          if (satVal == satTiming) {
            (
              document.getElementById('sat' + '_' + satVal) as HTMLInputElement
            ).checked = true;

            const checkArray: FormArray = this.checkBoxform.get(
              'Saturday'
            ) as FormArray;
            checkArray.push(new FormControl(satVal));
          }
        });
      });
    });
    ...
    this.date_time[6].forEach((value: any) => {
      value.Sunday.forEach((val: any) => {
        ...
        if (this.SunList.length == 0 && this.availData != null) {
          this.btnDisableSun = true;
          this.weekdayDisable['Sunday'] = true;
        ...
        this.SunList.forEach((sunTiming: any) => {
          if (sunVal == sunTiming) {
            ...
            checkArray.push(new FormControl(sunVal));
          }
        });
      });
    });
  ...
  checkSum() {
    if (
      ...
      this.weekdaysDayOffList['Sunday'] = 1;
    }
    if (
      (document.getElementById('mon_Dayoff') as HTMLInputElement).checked ==
      true
    ) {
      this.weekdaysDayOffList['Monday'] = 1;
    }
    if (
      (document.getElementById('tue_Dayoff') as HTMLInputElement).checked ==
      true
    ) {
      this.weekdaysDayOffList['Tuesday'] = 1;
    }
    if (
      (document.getElementById('wed_Dayoff') as HTMLInputElement).checked ==
      true
    ) {
      this.weekdaysDayOffList['Wednesday'] = 1;
    }
    if (
      (document.getElementById('thrs_Dayoff') as HTMLInputElement).checked ==
      true
    ) {
      this.weekdaysDayOffList['Thursday'] = 1;
    }
    if (
      (document.getElementById('fri_Dayoff') as HTMLInputElement).checked ==
      true
    ) {
      this.weekdaysDayOffList['Friday'] = 1;
    }
    if (
      (document.getElementById('sat_Dayoff') as HTMLInputElement).checked ==
      true
    ) {
      this.weekdaysDayOffList['Saturday'] = 1;
    }
    ...
    console.log('sum', this.sumOfday);

    if (this.sumOfday > 2) {
      alert('More than two dayoff not Possible, Something went wrong');
    }
  }
}
