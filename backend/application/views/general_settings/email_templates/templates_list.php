				...
				<div class="card card-primary">
					<div class="card-header">
						...
						<div class="float-sm-right">
							...
							<div id="add-email"><button type="button" class="btn btn-info btn" data-toggle="modal" data-target="#email-modal"><i class="fa fa-plus"></i></button></div>
...
<div id="email-modal" class="modal fade" role="dialog">
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<form id="emailForm" class="email-add" name="add-email" role="form">
...
<script>
	...
	$(function() {
		...
		$('#submit').on('click', function(e) {
			...
			$.ajax({
				type: "POST",
				url: '<?= base_url("general_settings/save") ?>',
				data: $('form.email-add').serialize(),
